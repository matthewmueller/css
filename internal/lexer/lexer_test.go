...
func TestComplex(t *testing.T) {
	...
	equal(t, "ul li:nth-last-child(-n+2) { font-weight: bold; }", `ident:"ul" space:" " ident:"li" : ident:"nth-last-child" ( nth:"-n" + number:"2" ) space:" " { space:" " ident:"font-weight" : space:" " ident:"bold" ; space:" " }`)
	equal(t, "ul li:nth-last-child(-n) { font-weight: bold; }", `ident:"ul" space:" " ident:"li" : ident:"nth-last-child" ( nth:"-n" ) space:" " { space:" " ident:"font-weight" : space:" " ident:"bold" ; space:" " }`)
	equal(t, "ul li:nth-last-child(-30n+20) { font-weight: bold; }", `ident:"ul" space:" " ident:"li" : ident:"nth-last-child" ( nth:"-30n" + number:"20" ) space:" " { space:" " ident:"font-weight" : space:" " ident:"bold" ; space:" " }`)
	equal(t, "ul li:nth-last-child(30n+20) { font-weight: bold; }", `ident:"ul" space:" " ident:"li" : ident:"nth-last-child" ( nth:"30n" + number:"20" ) space:" " { space:" " ident:"font-weight" : space:" " ident:"bold" ; space:" " }`)
	equal(t, "ul li:nth-last-child(30n) { font-weight: bold; }", `ident:"ul" space:" " ident:"li" : ident:"nth-last-child" ( nth:"30n" ) space:" " { space:" " ident:"font-weight" : space:" " ident:"bold" ; space:" " }`)
